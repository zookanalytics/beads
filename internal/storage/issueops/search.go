...
func searchTablePatternBT[T any](ctx context.Context, tx *sql.Tx, query string, filter types.IssueFilter, tables FilterTables, proj searchProjection[T]) ([]T, error) {
